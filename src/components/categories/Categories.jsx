...
//         onChange={setCategoryTitle}
//         placeholder="Select a category"
//         className={` ${isMobile ? 'mobile-dropdown' : 'desktop-dropdown'}`}
//         showSearch
//         allowClear
//         style={{ width: '200px'}}
//         optionFilterProp="children"
...
//           option?.children.toLowerCase().indexOf(input.toLowerCase()) >= 0
//         }
//         dropdownClassName={isMobile ? 'mobile-select-dropdown' : 'desktop-select-dropdown'}
//       >
//         {categories?.map((item) => (
//           <Select.Option key={item._id} value={item.title}>
//             {item.title}
...
//       {/* Add and Edit buttons for non-mobile */}
//       {!isMobile && (
//         <div className="flex justify-center gap-4 mt-3">
//           <Button
//             type="primary"
